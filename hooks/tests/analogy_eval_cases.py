...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="analogy-eval-") as tmp:
        ...
        cli.chmod(0o700)
        task = dict(id="fixture", style="proportional", params=dict(mode="proportional"),
    ...
    print("PASS: analogy exact scoring, uint64 IDs, explicit socket, error/timeout misses, 20 grounded tasks")
